...
function idInvalidCardCompanies(cardNumArr){
...
idInvalidCardCompanies([invalid1]); // Should print['visa']
idInvalidCardCompanies([invalid2]); // Should print ['mastercard']
idInvalidCardCompanies(batch); // Find out which companies have mailed out invalid cards
